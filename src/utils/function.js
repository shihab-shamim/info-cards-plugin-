  ...
  export const themeSwitch = (theme = "default", attributes) =>
    ...
    "newTab":true
        ...
        "translateX":"50%",
            ...
            "overlay": {
              "type": "gradient",
              "gradient": "linear-gradient(to top, rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0) 100%)"
            },
        "radius":{
        "top":"36px",
        "right":"36px",
  ...
  export function getCardContentEdit(
    ...
    if(theme === "theme10"){
      return(<div className="themeTenProductInfoGrab">
        <ThemeTenMouseMove isEditor={isBacked}  attributes={attributes} setAttributes={setAttributes} />
      </div>)
    }
  }
